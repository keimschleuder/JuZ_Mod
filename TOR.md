...
### **Team: Neutral**
  ...
  Der Kommunist ist eine neutrale Rolle, die jede andere Rolle ihre speziellen Fähigkeiten verlieren lassen kann

**NOTE**

- Der Kommunist kann nicht gewinnen

### Game Options

| Name | Description |
|----------|:-------------:|
| Kommunist Spawn Rate | - |
| Kommunist Cooldown | - |
| Kommunist Duration | - |
-----------------------
