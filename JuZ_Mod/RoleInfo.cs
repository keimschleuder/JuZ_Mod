...
namespace TheOtherRoles
{
    public class RoleInfo {
        ...
        public static RoleInfo snitch = new RoleInfo("Marcel", Snitch.color, "Das ist Respektlos einem ehemaligen <color=#E67E22>Jugendmoderator</color> gegenüber", "Finish your tasks", RoleId.Snitch);
